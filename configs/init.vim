...
nnormeap <silent> <C-g><f> :GitGutterNextHunk<CR>
nnoremap <silent> <C-g><S-f> :GitGutterPrevHunk<CR>
nnormeap <silent> <C-g><u> :GitGutterUndoHunk<CR>
nnormeap <silent> <C-g><t> :GitGutterToggle<CR>
