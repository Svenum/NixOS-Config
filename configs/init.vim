...
" shotcuts
nnoremap <C-g> <Nop>
nnoremap <C-g><p> :GitGutterPreviewHunk
nnoremap <C-g><f> :GitGutterNextHunk
nnoremap <C-g><S-f> :GitGutterPrevHunk
nnoremap <C-g><u> :GitGutterUndoHunk
nnoremap <C-g><t> :GitGutterToggle
