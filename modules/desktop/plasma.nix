...
in
{
  ...
  ] ++ (if settings.theme.flavour == "teal" [catppuccin-cursors.latteTeal catppuccin-cursors.mochaTeal] else if settings.theme.flavour == "red" [catppuccin-cursors.latteRed catppuccin-cursors.mochaRed] else if settings.theme.flavour == "peach" [catppuccin-cursors.lattePeach catppuccin-cursors.mochaPeach] else []);
